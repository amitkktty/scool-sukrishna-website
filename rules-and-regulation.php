...
<head>
    ...
    <title>Rules and Regulations | Sukrishna Commerce Patna</title>
    <meta name="description" content="Review the Rules and Regulations of Sukrishna Commerce in Patna. Understand our policies for a smooth coaching experience. Enroll now with confidence.">
    <meta name="keywords" content="Sukrishna Rules, Patna Coaching Policies, Commerce Education Guidelines, Sukrishna Regulations">
    <link rel="canonical" href="https://sukrishnacommerce.com/rules-and-regulation.php">
    <meta property="og:title" content="Rules and Regulations | Sukrishna Commerce Patna">
    <meta property="og:description" content="Learn about the Rules and Regulations of Sukrishna Commerce in Patna for a seamless coaching experience.">
    <meta property="og:url" content="https://sukrishnacommerce.com/rules-and-regulation.php">
    <meta property="og:type" content="website">
    <meta property="og:image" content="https://sukrishnacommerce.com/images/sukrishna-commerce-logo.png">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Rules and Regulations Sukrishna | Patna">
    <meta name="twitter:description" content="Rules and Regulations of Sukrishna Commerce in Patna. Learn more now.">
...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-main-wrapper">
                        <h1 class="title">Fee Rules and Regulations</h1>
                        <!-- breadcrumb pagination area -->
                        <div class="pagination-wrapper">
                            <a href="index.php">Home</a>
                            <i class="fa-regular fa-chevron-right"></i>
                            <a class="active" href="#!"> Fee Rules and Regulations</a>
                        </div>
            ...
            <div class="row align-items-center">
                        ...
                        <div class="first-order">
                            <div class="thumb-one">
                                ...
                                <div class="information">
                                    <div class="left">
                                        <h3 class="title"><span class="counter animated fadeInDownBig">22</span>k</h3>
                            ...
                            <div class="thumb-bottom">
                                <img src="images/02.jpg" alt="about">
                            </div>
                        </div>
                        <div class="second-order">
                            <img src="images/sw.jpg" alt="about">
                ...
                <div class="col-xl-6 col-lg-12 pl--60 pl_md--10 pl_sm--10 pt--50">
                    <div class="title-area-left-style">
                        ...
                        <h2 class="title">FEE REGULATIONS</h2>
                        <ul class="sadqw">
                            <li>Fee Refund Policy:<br>
                                (I) Only 50% of tuition Fee is considerable within a week (7 Days ) of admission.<br>
                                (ii) No fee is Refundable /transferable (After 7 days) of admission.</li>
                            <li>All fee must be cleared within 30 days otherwise entry may be declined.</li>
                            <li>In case of discontinuation of course in between under any circumstances, the student
                                will have to pay all the full course/programme fees.</li>
                            <li>Jurisdiction for all disputes (IF any) relating to the Sukrishna Commece Academy (P)
                                Ltd. Patna, Bihar, India. </li>
                        </ul>
                    </div>
    ...
    <!-- <div class="becom-an-instructor-form-area rts-section-gapTop pl--120 pr--120 pl_sm--10 pt-0 pr_sm--10">
         <div class="title-instructor-wrapper">
            <h2 class="title">Make An Enquiry</h2>
            <p class="disc">
               Got questions? We’re here to help! Whether you need detailed information about our services, want a personalized quote, or have any specific requirements, feel free to reach out.
            </p>
         </div>
         <form action="#" class="instructor-form"> 
            ...
            <button class="rts-btn btn-primary mb--30">Submit Now </button>
         </form>
      </div> -->
