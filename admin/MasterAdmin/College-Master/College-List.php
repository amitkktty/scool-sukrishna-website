<?php 
$page='college'; $innerpage='collegelist';
    ...
    <section >
      <div class="container-fluid text-uppercase ">
	   <div class="row bg-white p-2" style='box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px;'>
	    ...
	    <div>
		  ...
		  <h6 class='text-primary bold mt-n3'>College List</h6></h3>
		</div>	   
	   </div><br>		
      </div>
	  ...
	  <div class="container-fluid px-4 ">
        <div class="col-md-12 mx-auto p-3 bg-white" style='box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;'>
			...
			<?php 
			$sn =1;
			$q1="select * from college_data order by college_name  ";
			...
			<td class="text-center"><?php echo $sn;?></td>
				...
				<td class='text-center'><a href="collegeGallery?c_id=<?php echo $c_id;?>" class='btn btn-sm btn-outline-success'><i class="fa fa-image" aria-hidden="true"></i></a> </td> 
				
				<td class='text-center'><a href="collegeNotification?c_id=<?php echo $c_id;?>" class='btn btn-sm btn-outline-danger'><i class="fa fa-bell" aria-hidden="true"></i></a>  <a href="Modify-College?c_id=<?php echo $c_id;?>" class='badge badge-primary p-2 px-3'><i class="fa fa-edit" aria-hidden="true"></i></a> </td> 
			</tr>
