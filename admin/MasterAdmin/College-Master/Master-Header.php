    ...
    <div class="sidebar">  
      ...
      <nav class="mt-2 py-md-0">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item <?php if($page=='college') echo ' menu-open';?>">
            <a href="#" class="nav-link  <?php if($page=='college') echo ' active';?>">
            ...
            <ul class="nav nav-treeview">
              <!--<li class="nav-item">
                <a href="Add-College" class="nav-link <?php if($innerpage=='addcollege') echo ' active';?>">
                  <i class="fa fa-caret-right nav-icon"></i>
                  <p>Add College</p>
                </a>
              </li>-->
              <li class="nav-item">
                <a href="../College-Master/College-List" class="nav-link <?php if($innerpage=='collegelist') echo ' active';?>">
                  <i class="fa fa-caret-right nav-icon"></i>
                  <p>College List</p>
                </a>
              </li>
              <li class="nav-item">
               ...
               <!--<li class="nav-item">
                <a href="../College-Master/seat-matrix" class="nav-link <?php if($innerpage=='seat') echo ' active';?>">
                  <i class="fa fa-caret-right nav-icon"></i>
                  <p>Seat Matrix</p>
                </a>
              </li>-->
		  ...
		  <li class="nav-item">
			...
			<ul class="nav nav-treeview">
				<li class="nav-item">
					<a href="../Exam-Master/Exam-Level" class="nav-link">
						<i class="fa fa-caret-right nav-icon"></i>
						<p>Exam Level</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="../Exam-Master/Add-Exam" class="nav-link">
						<i class="fa fa-caret-right nav-icon"></i>
						<p>Add Exam</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="../Exam-Master/Exam-List" class="nav-link">
						<i class="fa fa-caret-right nav-icon"></i>
						<p>Exam List</p>
					</a>
				</li>                           
		...
		<li class="nav-item">
			...
			<ul class="nav nav-treeview"> 
				<li class="nav-item">
					<a href="../Adv-Master/Add-Adv" class="nav-link">
						<i class="fa fa-caret-right nav-icon"></i>
						<p>New Adv.</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="../Adv-Master/Adv-List" class="nav-link">
						<i class="fa fa-caret-right nav-icon"></i>
						<p>Adv List</p>
					</a>
				</li>                           
		...
		<li class="nav-item">
			...
			<ul class="nav nav-treeview"> 
				<li class="nav-item">
					<a href="../Enquiry/Registration-Data" class="nav-link">
						<i class="fa fa-caret-right nav-icon"></i>
						<p>Registration Data</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="../Enquiry/Signup-Data" class="nav-link">
						<i class="fa fa-caret-right nav-icon"></i>
						<p>Signup Data</p>
					</a>
				</li>
				<a href="../Enquiry/Enquiry-Data" class="nav-link ">
					<i class="fa fa-caret-right nav-icon"></i>
					<p>Enquiry Data</p>
				</a>                        
			</ul>
		...
		<li class="nav-item">
			...
			<ul class="nav nav-treeview"> 
				<li class="nav-item">
					<a href="../Extra-Page/Page-Create" class="nav-link">
						<i class="fa fa-caret-right nav-icon"></i>
						<p>Page Create</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="../Extra-Page/Page-List" class="nav-link">
						<i class="fa fa-caret-right nav-icon"></i>
						<p>Page List</p>
					</a>
				</li>
