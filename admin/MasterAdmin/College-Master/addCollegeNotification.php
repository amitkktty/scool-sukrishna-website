...
$_SESSION['backlink'] = 'addCollegeNotification';
...
if (isset($_POST['submit'])) 
{
	...
	{ 
		...
		else
		{
			...
			echo "<form action=addCollegeNotification method=post name=main></form>
			<script>document.main.submit(); </script>"; 		   
		}	
	}
}  
...
?>	
	...
	<div>
	  <form action="addCollegeNotification" method="POST" enctype="multipart/form-data">
		<div class="row bold">
