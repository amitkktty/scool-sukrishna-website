...
<!-- ./wrapper -->
<script src="../plugins/chosen/docsupport/jquery-3.2.1.min.js" type="text/javascript"></script>
  ...
  <script src="../plugins/chosen/docsupport/init.js" type="text/javascript" charset="utf-8"></script>
<!-- jQuery --> 
