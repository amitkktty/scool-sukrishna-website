...
if(empty($c_id ))
{ 
  echo "<script>window.location.href='University-List';</script>";
}
else
{
...
if(!empty($_FILES ['logoImg']['name']))
		...
		if(!empty($_FILES ['bannerImg']['name']))
		{
		 ...
		 $q = "update college_data set college_name= '$college_name',college_nick_name = '$polpular_name', short_name='$short_name', college_seo_url  = '$slug', college_type = '$college_type', college_estd = '$estd_year', college_ownership = '$ownership_id', exam_acceptance = '$affiliat', country1 = '101', state1 = '$state_id1', district1 = '$district_id1', about_college = '$aboutcollege', college_logo = '$logo_file_name', college_banner = '$banner_file_name' where c_id='$c_id'";
			...
			else
			{
			   ...
			   /* echo "<script>Swal.fire(
				...
				window.location = 'College-List';
					...
					echo "<form action='Modify-University' method=post name=main></form>
...
else
{
	...
	$affiliation1  	= $rr->exam_acceptance; 
...
<div class="content-wrapper">
      ...
      <div class="container-fluid text-uppercase ">
	   <div class="row bg-white p-2" style='box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px;'>
	    ...
	    <div>
		  ...
		  <h6 class='text-primary bold mt-n3'>Modify University</h6></h3>
		</div>	   
	   </div><br>		
      </div>
   ...
   <div class='container-fluid '>	
	...
	<div>
	  <form action="Modify-University?c_id=<?php echo $c_id;?>" method="POST" enctype="multipart/form-data">
		<div class="row bold mt-3">
		  <div class="col-md-12 ">University Name * : <?php echo $errors[college_name];?>
		  <input type="text" required='' class='form-control form-control-sm'   name='college_name' value='<?php echo $college_name;?>' />	  
		  </div>
		  <div class="col-md-4 ">Popular Name  :  <?php echo $errors[polpular_name];?>
		  <input type="text"  required='' class='form-control form-control-sm' name='polpular_name' value='<?php echo $polpular_name;?>'  />				  
		  </div>
		  <div class="col-md-4 ">Short Name  : 
		  <input type="text"  required='' class='form-control form-control-sm' name='short_name' value='<?php echo $short_name;?>'  />				  
		  </div>
		  ...
		  <div class="col-md-6 	">Exam Acceptence * :   <br> 
