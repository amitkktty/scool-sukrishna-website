        ...
        <div class="d-flex justify-content-start flex-wrap">  
		  ...
		  <div class="col-lg-3 col-md-4 p-1 px-3 "> 
            <div class="row"style='background:#ffad33; color:White;' >
			  ...
			  <div class="col-12" style='background:#995c00;'>
		  ...
		  <div class="col-lg-3 col-md-4 p-1 px-3 "> 
            <div class="row"style='background:#FF8557; color:White;' >
			  ...
			  <div class="col-12" style='background:#FF4600;'>
		  ...
		  <div class="col-lg-3 col-md-4 p-1 px-3 "> 
            <div class="row"style='background:#E645E8; color:White;' >
              <div class="col-8 pl-3">
		  ...
		  <div class="col-lg-3 col-md-4 p-1 px-3 "> 
            <div class="row"style='background:#b2b266; color:White;' >
			  ...
			  <div class="col-12" style='background:#666633;'>
		  ...
		  <div class="col-lg-3 col-md-4 p-1 px-3 "> 
            <div class="row"style='background:#e6e600; color:White;' >
              <div class="col-8 pl-3">
		  ...
		  <div class="col-lg-3 col-md-4 p-1 px-3 "> 
            <div class="row"style='background:#d9b38c; color:White;' >
			  ...
			  <div class="col-12" style='background:#bf8040;'>
		  ...
		  <div class="col-lg-3 col-md-4 p-1 px-3 "> 
            <div class="row"style='background:#00b3b3; color:white;' >
              <div class="col-8 pl-3">
			  ...
			  <div class="col-12" style='background:#004d4d;'>
