    ...
    <section >
	  ...
	  <div class="container-fluid px-4 ">
        <div class="col-md-11 mx-auto p-3 bg-white" style='box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;'> <br>
			<div id="display_data">
			<h4 class='text-center bg-info'>List of Added Data (Registration Details)</h4>
			...
			<?php
			$sn =1;
			$q1="select * from online_registration order by id desc ";
