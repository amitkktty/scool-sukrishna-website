...
{
	$sql="select * from exam_level where exm_id ='$id'";
...
if (isset($_POST['submit'])) 
{
	...
	else
	{
		...
		{
			$q10 = "select * from exam_level where exam_level_name  ='$exam_level_name' AND exm_id !='$id'";
	...
	if(empty($errors))
	{
		...
		$q = "update exam_level set exam_level_name = '$exam_level_name' where exm_id ='$id'";
...
else
{
	...
	$exam_level_name  	= $rr->exam_level_name; 
}
?>
...
<div class="content-wrapper"> 
 ...
 <div class="container-fluid px-4 ">
   <div class="col-md-8 mx-auto p-3 bg-white" style='box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;'>
	...
	<div>
	  <form action="Exam-Level-Modify?id=<?php echo $id;?>" method="POST" enctype="multipart/form-data">
		<div class="row bold">
		  ...
		  <div class="col-md-4 my-2 text-center"> <br>			
			...
			<a href='Add-College' class="bold btn btn-sm bg-info px-3 mx-2">Back </a>
		  </div>		  
		</div>			
	  </form> 
	</div>
...
if($found_data > 0)
{
	...
	<tr class="header">
		...
		<td class='text-center'>
		  <a href="Exam-Level-Modify?id=<?php echo $exm_id;?>" class='px-3 mx-1 btn btn-sm btn-success bold'>Edit</a>
		  <a href="deleteExamLevel?id=<?php echo $exm_id;?>" onclick="return confirm('Are you sure?')" class='px-2 mx-1 btn btn-sm btn-danger bold'>Delete</a>
		</td>
	</tr>
	<?php
	$sn++;
