    ...
    $name = $_FILES["image"]["name"];
        $tmp = $_FILES["image"]["tmp_name"];
            ...
            $image = $upload_dir.$name;
                        ...
                        $sql="update category set category_name='$names',image='$image' where cat_id='$cat_id'";
                    }
                    else
                    {
                      $sql="update category set category_name='$names' where cat_id='$cat_id'";  
                    }
...
<div class="content-wrapper">
    ...
    <section>
       ...
       <?php
                    $sn = 1;
                    $q1 = "select * from category where cat_id='$cat_id'";
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row bold">
                        	<div class="col-md-4 my-2">
                                ...
                                <input type="text" value="<?php echo $r1->category_name;?>" class='form-control form-control-sm' name='name'
                                    required />
                            </div>
