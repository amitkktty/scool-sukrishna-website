...
if (isset($_POST['submit'])) {
 ...
 $url = mysqli_real_escape_string($conn,$_POST['url']);   
                        ...
                        $sql="insert into video(category_name,url)values('$category','$url')";
        ...
        <div class="container-fluid px-4 ">
            <div class="col-md-8 mx-auto p-3 bg-white"
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row bold">
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <input type="text" class='form-control form-control-sm' name='url' placeholder="https://www.youtube.com/watch?v=XXvvjqpL-wI" 
                                    required />
                            </div>
                ...
                <table id="myTable" class='table table-sm table-bordered small bold'>
                    ...
                    <?php
					$sn = 1;
					$q1 = "select * from video order by video_id";
