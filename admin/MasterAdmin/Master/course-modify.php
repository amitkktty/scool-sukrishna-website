...
if (isset($_POST['submit'])) {
 ...
 $course = mysqli_real_escape_string($conn,$_POST['cname']);
                      ...
                      $sql="update course set course='$course' where course_id='$course_id'";  
...
<div class="content-wrapper">
    ...
    <section>
            ...
            <div class="row bg-white p-2"
                ...
                <div>
                    <h3 class='bold text-danger'>Result Master
                        <h6 class='text-primary bold mt-n3'>Course</h6>
                    </h3>
                </div>
            </div><br>
        </div>
       ...
       <?php
                    ...
                    $q1 = "select * from course where course_id='$course_id'";
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row bold">
                        	<div class="col-md-8 my-2">
                                ...
                                <input type="text" value="<?php echo $r1->course;?>" class='form-control form-control-sm' name='cname'
                                    required />
                            </div>
