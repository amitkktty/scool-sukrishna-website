      ...
      <div class="container-fluid text-uppercase ">
	   <div class="row bg-white p-2" style='box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px;'>
	    ...
	    <div>
		  ...
		  <h6 class='text-primary bold mt-n3'>View Test</h6></h3>
		</div>	   
	   </div><br>		
      </div>
	  ...
	  <div class="container-fluid px-4 ">
        <div class="col-md-11 mx-auto p-3 bg-white" style='box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;'>
			...
			<?php
                ...
                {
                    $delc = $_REQUEST['dele'];
                    $delQ = "DELETE FROM `test` WHERE `test_id` = $delc";
                    mysqli_query($conn, $delQ);
                    header("location: view-test");
                } ?>
		   <table id="example1" class="table table-bordered table-striped">
			...
			$q1="select * from test order by test_id ";
			...
			<td class='text-center'><?php echo $sn;?></td>
				...
				<td class='text-center'><a href="test-modify?id=<?php echo $r1->test_id;?>" class='badge badge-primary p-2 px-3'><i class="fa fa-edit" aria-hidden="true"></i></a> <a href="view-test?dele=<?php echo $r1->test_id;?>" onclick="return confirm('Are you sure ?')" class='badge badge-danger p-2 px-3'><i class="fa fa-trash" aria-hidden="true"></i></a></td> 
			</tr>
