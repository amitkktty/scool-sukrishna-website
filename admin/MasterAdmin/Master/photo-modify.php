    ...
    $name = $_FILES["image"]["name"];
        $tmp = $_FILES["image"]["tmp_name"];
            ...
            $image = $upload_dir.$name;
              ...
              $sql="update photo set category_name='$category',image='$image' where photo_id='$photo_id'";          

                    }
                    else
                    {
                      $sql="update photo set category_name='$category' where photo_id='$photo_id'";
                    }
            ...
            <div class="row bg-white p-2"
                ...
                <div>
                    <h3 class='bold text-danger'> Gallery
                        <h6 class='text-primary bold mt-n3'>Photo</h6>
                    </h3>
                </div>
            </div><br>
        </div>
...
$sql=mysqli_query($conn,"select * from photo where photo_id='$photo_id'");
...
?>
        <div class="container-fluid px-4 ">
            <div class="col-md-8 mx-auto p-3 bg-white"
                ...
                {
                    $delc = $_REQUEST['dele'];
                    $delQ = "DELETE FROM `photo` WHERE `photo_id` = $delc";
                ...
                <table id="myTable" class='table table-sm table-bordered small bold'>
                    ...
                    <?php
					$sn = 1;
					$q1 = "select * from photo where photo_id='$photo_id'";
                    ...
                    <tr class="header">
                        ...
                        <td class='text-center'><a href="photo-modify?id=<?php echo $r1->photo_id; ?>"
                                class='badge badge-primary p-2 px-3'><i class="fa fa-edit" aria-hidden="true"></i></a>
                            <a href="photo?dele=<?php echo $r1->photo_id;?>" onclick="return confirm('Are you sure ?')" class='badge badge-danger p-2 px-3'><i class="fa fa-trash" aria-hidden="true"></i></a>
                        </td>
                    </tr>
