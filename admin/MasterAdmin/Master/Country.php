        ...
        <div class="col-md-11 mx-auto p-3 bg-white" style='box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;'>
			...
			<div class='container-fluid '>
			 <div class="row bold">
				...
				<div class="col-6 text-right"> <a href="Country" class='bg-info px-3 py-1 ml-n2 rounded sd-1'>
			...
			<?php
                ...
                {
                    $delc = $_REQUEST['dele'];
                    $delQ = "DELETE FROM `country_data` WHERE `country_id` = $delc";
			...
			$q1="select * from country_data order by name ";
			...
			<td class='text-center'><?php echo $sn;?></td>
				...
				<td class='text-center'><a href="Country-Modify?id=<?php echo $country_id1;?>" class='badge badge-primary p-2 px-3'><i class="fa fa-edit" aria-hidden="true"></i></a> <a href="Country?dele=<?php echo $country_id1;?>" onclick="return confirm('Are you sure ?')" class='badge badge-danger p-2 px-3'><i class="fa fa-trash" aria-hidden="true"></i></a></td> 
			</tr>
